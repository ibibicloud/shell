...
Install_Python_Lib(){
	curl -Ss --connect-timeout 3 -m 60 https://raw.githubusercontent.com/ibibicloud/shell/master/install/pip_select.sh|bash
...
Install_Bt(){
	...
	wget -O /etc/init.d/bt https://raw.githubusercontent.com/ibibicloud/shell/master/install/src/bt6.init -T 10
	wget -O /www/server/panel/install/public.sh https://raw.githubusercontent.com/ibibicloud/shell/master/install/public.sh -T 10
	wget -O panel.zip https://raw.githubusercontent.com/ibibicloud/shell/master/install/src/panel-v6.zip -T 10
	...
	wget -O /etc/init.d/bt https://raw.githubusercontent.com/ibibicloud/shell/master/install/src/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://raw.githubusercontent.com/ibibicloud/shell/master/install/src/bt7.init -T 10
}
...
Set_Bt_Panel(){
	...
	LOCAL_CURL=$(curl 127.0.0.1:9898/login 2>&1 |grep -i html)
...
+----------------------------------------------------------------------
| The WebPanel URL will be http://SERVER_IP:9898 when installed.
+----------------------------------------------------------------------
"
while [ "$go" != 'y' ] && [ "$go" != 'n' ]
do
