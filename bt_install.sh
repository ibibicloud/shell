...
Install_Python_Lib(){
	curl -Ss --connect-timeout 3 -m 60 https://cdn.jsdelivr.net/gh/ibibicloud/shell/install/pip_select.sh|bash
...
Install_Bt(){
	...
	wget -O /etc/init.d/bt https://cdn.jsdelivr.net/gh/ibibicloud/shell/install/src/bt6.init -T 10
	wget -O /www/server/panel/install/public.sh https://cdn.jsdelivr.net/gh/ibibicloud/shell/install/public.sh -T 10
	wget -O panel.zip https://cdn.jsdelivr.net/gh/ibibicloud/shell/install/src/panel-v6.zip -T 10
	...
	wget -O /etc/init.d/bt https://cdn.jsdelivr.net/gh/ibibicloud/shell/install/src/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://cdn.jsdelivr.net/gh/ibibicloud/shell/install/src/bt7.init -T 10
}
